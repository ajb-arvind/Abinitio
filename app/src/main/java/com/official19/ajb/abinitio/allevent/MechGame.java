    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (event)
        {
            case "RC Nitro Racing":
                RulesCardHidden.setText("Mech_1 Rules");
                PrizeCardHidden.setText("Mech_1 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Mech_1");
                cordintor_no="tel:9370088262";
                break;

            case "Consilio":
                RulesCardHidden.setText("Mech_2 Rules");
                PrizeCardHidden.setText("Mech_2 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Mech_2");
                cordintor_no="tel:9284705198";
                break;

            case "The Catapult":
                RulesCardHidden.setText("Mech_3 Rules");
                PrizeCardHidden.setText("Mech_3 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Mech_3");
                cordintor_no="tel:8830678511";
                break;

            case "Linkage and Gear":
                RulesCardHidden.setText("Mech_4 Rules");
                PrizeCardHidden.setText("Mech_4 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Mech_4");
                cordintor_no="tel:9370088262";
                break;
