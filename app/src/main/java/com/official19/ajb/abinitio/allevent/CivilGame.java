...
public class CivilGame extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            case "Spaco Frame":
                RulesCardHidden.setText("Civil_1 Rules");
                PrizeCardHidden.setText("Civil_1 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Civil_1");
                cordintor_no="tel:9370088262";
                break;

            case "Poster Presentation":
                RulesCardHidden.setText("Civil_2 Rules");
                PrizeCardHidden.setText("Civil_2 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Civil_2");
                cordintor_no="tel:9284705198";
                break;

            case "Clad Clash":
                RulesCardHidden.setText("Civil_3 Rules");
                PrizeCardHidden.setText("Civil_3 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Civil_3");
                cordintor_no="tel:8830678511";
                break;

            case "Treasure Hunt":
                RulesCardHidden.setText("Civil_4 Rules");
                PrizeCardHidden.setText("Civil_4 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators Civil_4");
                cordintor_no="tel:9370088262";
                break;
