    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (event)
        {
            case "Spechien Sie Matlab":
                RulesCardHidden.setText("EnTC_1 Rules");
                PrizeCardHidden.setText("EnTC_1 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators EnTC_1");
                cordintor_no="tel:9370088262";
                break;

            case "Electro-Spark":
                RulesCardHidden.setText("EnTC_2 Rules");
                PrizeCardHidden.setText("EnTC_2 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators EnTC_2");
                cordintor_no="tel:9284705198";
                break;

            case "Utrix":
                RulesCardHidden.setText("EnTC_3 Rules");
                PrizeCardHidden.setText("EnTC_3 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators EnTC_3");
                cordintor_no="tel:8830678511";
                break;

            case "Robox":
                RulesCardHidden.setText("EnTC_4 Rules");
                PrizeCardHidden.setText("EnTC_4 prize");
                Co_OrdinatorCardHidden.setText("Auto_Cordinators EnTC_4");
                cordintor_no="tel:9370088262";
                break;
